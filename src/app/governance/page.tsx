  ...
  const systems = [
    {
      ...
      text: "Frameworks for oversight, operational control, and policy enforcement across autonomous AI ecosystems.",
    },
    {
      icon: Globe,
      title: "Digital Sovereignty",
      text: "Sovereign infrastructure models for nations, institutions, and future AI-native governance systems.",
    },
    {
      icon: Scale,
      title: "Regulatory Intelligence",
      text: "AI-driven compliance, auditability, legal orchestration, and adaptive governance architectures.",
    },
    {
      icon: Cpu,
      title: "Autonomous Governance Infrastructure",
      text: "Research and development of civilization-scale governance systems for future intelligent societies.",
    },
  ];
      ...
      <section className="px-6 pt-40 pb-24 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="mt-8 text-gray-400 text-lg leading-relaxed max-w-3xl mx-auto">
            CIVITERA develops governance architectures for sovereign AI,
            digital infrastructure, autonomous systems,
            regulatory intelligence, and civilization-scale coordination.
          </p>
